...
import com.chupryna.socialapplication.data.model.*
...
import com.chupryna.socialapplication.data.todo.local.ToDoDao
import com.chupryna.socialapplication.data.user.local.UserDao

@Database(entities = [Album::class, Photo::class, Post::class, User::class, Comment::class, ToDo::class], version = 1)
